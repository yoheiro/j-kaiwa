...
function MkQuizlist(e){
  ...
  function checkAnswer(e){
    ...
    if( UserAnswer[0]== ANSWER) {
      // 当たった時の挙動
      currentQ[e][6]=1;
  //Stuckanswer[0]=Stuckanswer[0]+'<ons-list-item>'+ANSWER+'<div class="right" ><ons-icon icon="check" size="23px" style=" color: green;"></ons-icon></div></ons-list-item>';
    ...
    // Stuckanswer[0]+='<ons-list-item>'+UserAnswer[0]+'<div class="right"><i class="fas fa-times-circle" style="color: red;"></i></div></ons-list-item>';
    currentQ[e][6]=2;
  }
  };
